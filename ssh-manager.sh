...
function list_commands() {
    ...
    separator
    echo -e "ssh-manager \t\t\t\t\tlist all servers"
    echo -e "ssh-manager \t<alias> [username]\t\tconnect to server"
    echo -e "ssh-manager add\t<alias>:<user>:<host>:[port]:[desc]\tadd new server"
    echo -e "ssh-manager del\t<alias>\t\t\t\tdelete server"
    echo -e "ssh-manager cp\t<alias>\t\t\t\tssh-copy-id to server"
    echo -e "ssh-manager export\t\t\t\texport config"
    echo -e "ssh-manager -h / --help\t\t\t\tprint this message"
}
